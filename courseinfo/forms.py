...
class RegistrationForm(forms.ModelForm):
    ...
    def clean_registration_student(self):
        return self.cleaned_data['registration_student'].strip()

    def clean_registration_section(self):
        return self.cleaned_data['registration_section'].strip()
